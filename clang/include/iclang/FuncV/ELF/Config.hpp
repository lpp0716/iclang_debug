...
#ifndef ICLANG_CONFIG_HPP
#define ICLANG_CONFIG_HPP
...
public:
  ...
  // We only support 64 kind, and the word size is always 8.
...
public:
  ...
  static std::string sectionFlagToString(const uint64_t flag) {
    ...
    if ((flag & llvm::ELF::SHF_GNU_RETAIN) ||
      (flag & llvm::ELF::SHF_EXCLUDE) ||
      ...
      (flag & llvm::ELF::SHF_MIPS_MERGE) ||
      (flag & llvm::ELF::SHF_MIPS_ADDR) ||
